...
# f: Input filename
# SC: the horizontal pixel sampling rate. It should be between 0(exclusive) and 1(inclusive).
...
# GCF: >0. It's an image tuning factor. If GCF>1, the image will look brighter; if 0<GCF<1,
